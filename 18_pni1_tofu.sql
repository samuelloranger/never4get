...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 15 nov. 2018 à 19:57
...
--
-- Déchargement des données de la table `t_liste`
--
...
--
-- AUTO_INCREMENT pour la table `t_liste`
--
ALTER TABLE `t_liste`
...
--
-- Contraintes pour la table `t_liste`
--
ALTER TABLE `t_liste`
