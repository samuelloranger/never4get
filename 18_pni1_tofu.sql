...
--
-- Host: localhost
-- Generation Time: Dec 03, 2018 at 12:28 AM
...
(1, 'rigatonia', '2019-02-26 05:07:00', 0, 1),
(2, 'coriandre', NULL, 0, 1),
(3, 'Dissertation sur Zarathoustra', '2020-12-11 04:18:00', 0, 2),
...
(58, 'Faire les esquisses fonctionnelles', '2019-11-15 00:00:00', 1, 2),
(59, 'Examen de programmation', '2019-12-06 10:00:00', 1, 2),
...
ALTER TABLE `t_liste`
  ...
  ADD KEY `t_liste_ibfk_2` (`id_utilisateur`),
  ADD KEY `t_liste_ibfk_3` (`id_couleur`);
...
--
ALTER TABLE `t_liste`
  ADD CONSTRAINT `t_liste_ibfk_2` FOREIGN KEY (`id_utilisateur`) REFERENCES `t_utilisateur` (`id_utilisateur`) ON UPDATE CASCADE,
  ADD CONSTRAINT `t_liste_ibfk_3` FOREIGN KEY (`id_couleur`) REFERENCES `t_couleur` (`id_couleur`) ON UPDATE CASCADE;
